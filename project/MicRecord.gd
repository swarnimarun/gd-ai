...
var stereo := true
var mix_rate := 48000  # This is the default mix rate on recordings
var format := AudioStreamWAV.FORMAT_16_BITS  # This equals to the default format: 16 bits
...
func _on_RecordButton_pressed():
	if effect.is_recording_active():
		...
		$VBoxContainer/SaveButton.disabled = false
		...
		$VBoxContainer/SaveButton.disabled = true
...
func _on_SaveButton_pressed():
	var save_path = $VBoxContainer/Filename.text
